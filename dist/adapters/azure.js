...
exports.wrapAzureOpenAITools = wrapAzureOpenAITools;
 ...
 */
function wrapAzureOpenAITools(tools, options) {
    const optsWithProvider = { provider: 'azure-openai', framework: 'Azure OpenAI SDK', ...options };
