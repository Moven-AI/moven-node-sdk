...
exports.wrapBedrockTools = wrapBedrockTools;
 ...
 */
function wrapBedrockTools(tools, options) {
    const optsWithProvider = { provider: 'aws-bedrock', framework: 'AWS Bedrock Converse API', ...options };
