...
exports.wrapMistralTools = wrapMistralTools;
 ...
 */
function wrapMistralTools(tools, options) {
    const optsWithProvider = { provider: 'mistral', framework: 'Mistral AI SDK', ...options };
